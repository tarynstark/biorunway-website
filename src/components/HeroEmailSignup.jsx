...
export default function HeroEmailSignup() {
  ...
  return (
    <div className="w-full max-w-[360px] px-6 py-2.5 overflow-hidden rounded-[80px] justify-start items-start gap-2.5 inline-flex">
      ...
      {status && (
        <div className="absolute mt-16 text-center w-full">
